...
const helpContent = {
	shellType: {
		header: 'Type of Fireworks',
		body: 'The type of fireworks that will be launched. Select "Random" for a nice assortment!'
	},
	shellSize: {
		header: 'Fireworks size',
		body: 'Size of fireworks. Modeled after the size of real fireworks shells, larger shells have larger explosions with more stars and sometimes more complex effects. However, larger shells also require more processing power and can cause lag.'
	},
	quality: {
		header: 'Graphics Quality',
		body: 'Overall graphics quality. If the animation does not run smoothly, try reducing the quality. High quality significantly increases the amount of spark and can cause delay.'
	},
	skyLighting: {
		header: 'Sky Effect',
		body: 'Light up the background as the fireworks explode. If the background looks too bright on your screen, try setting it to "Dim" or "None".'
	},
	scaleFactor: {
		header: 'Chain of Fireworks',
		body: 'Allows the size of all fireworks to scale, essentially moving you closer or further away. For larger case sizes, it can be convenient to scale it down a bit, especially on phones or tablets.'
	},
	autoLaunch: {
		header: 'Automatic Fireworks',
		body: 'Automatically starts fireworks sequences. Sit back and enjoy the show, or turn it off for full control.'
	},
	finaleMode: {
		header: 'Final Mode ',
		body: 'Launching intense fireworks. May cause lag. Requires "Auto-Fire" to be enabled.'
	},
	hideControls: {
		header: 'Hide Controls',
		body: 'Hide the translucent controls along the top of the screen. Useful for screenshots or just a more seamless experience. While hidden, you can still tap the top right corner to reopen this menu.'
	},
	fullscreen: {
		header: 'Full Screen',
	...
	longExposure: {
		...
		body: 'The experimental effect preserves long light trails, similar to leaving a camera shutter open.'
	}
};
